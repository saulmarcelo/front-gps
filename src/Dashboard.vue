...
// Estado para modal de agregar usuario
          ...
          <div class="backdrop-blur-xl bg-white/90 border border-blue-100 rounded-2xl overflow-hidden shadow-xl">
            <div class="p-6 border-b border-blue-200/50 bg-gradient-to-r from-white/10 to-transparent flex justify-between items-center">
              ...
              <button
                ...
                class="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-3 rounded-xl font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 hover:-translate-y-0.5 flex items-center gap-2">
                <Plus class="w-4 h-4" />
                Nuevo Usuario
              </button>
            </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="group relative overflow-hidden bg-gradient-to-br from-white/10 to-white/5 border border-blue-100 rounded-2xl p-8 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 hover:-translate-y-2 cursor-pointer">
                  ...
                  <div class="relative text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform">
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-white/10 to-white/5 border border-blue-100 rounded-2xl p-8 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-2 cursor-pointer">
                  <div class="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div class="relative text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform">
...
<div v-if="showAddStudentForm" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in"
     @click="showAddStudentForm = false">
  <div class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-zoom-in" @click.stop>
    <div class="p-6 border-b border-gray-200">
      <h2 class="text-2xl font-bold text-gray-800">Agregar Nuevo Estudiante</h2>
    </div>
    <form @submit.prevent="handleAddStudent" class="p-6 space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Nombre Completo</label>
          <input v-model="newStudent.name" type="text" placeholder="Ej: María González Pérez" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">RUT</label>
          <input v-model="newStudent.rut" type="text" placeholder="Ej: 12.345.678-9" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Curso</label>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Escuela</label>
          <select v-model="newStudent.school" required
                  class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            <option value="">Seleccionar escuela</option>
            <option v-for="school in schools" :key="school.id" :value="school.name">{{ school.name }}</option>
          </select>
        ...
        <div>
          ...
          <input v-model="newStudent.birthDate" type="date" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Dirección</label>
          <input v-model="newStudent.address" type="text" placeholder="Ej: Camino Rural Km 12, Temuco" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Apoderado</label>
          <input v-model="newStudent.guardian" type="text" placeholder="Ej: Carmen Pérez" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Teléfono</label>
          <input v-model="newStudent.phone" type="tel" placeholder="Ej: +56 9 8765 4321" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
      </div>
      <div class="flex gap-3 pt-4">
        ...
        <button type="button" @click="showAddStudentForm = false" class="border border-gray-300 text-gray-700 px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors">
          Cancelar
        </button>
      </div>
    </form>
...
<div v-if="showAddUserForm" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in"
  ...
  <div class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-zoom-in" @click.stop>
    ...
    <form @submit.prevent="handleAddUser" class="p-6 space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Nombre Completo</label>
          <input v-model="newUser.name" type="text" placeholder="Ej: Juan Pérez" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
          <input v-model="newUser.email" type="email" placeholder="Ej: juan.perez@escuela.cl" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
        </div>
        <div>
        ...
        <div class="md:col-span-2">
          ...
          <input v-model="newUser.password" type="password" placeholder="Contraseña temporal" required
                 class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
        </div>
      </div>
      <div class="flex gap-3 pt-4">
        <button type="submit" class="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-8 py-3 rounded-xl font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 hover:-translate-y-0.5">
          Agregar Usuario
        </button>
        <button type="button" @click="showAddUserForm = false" class="border border-gray-300 text-gray-700 px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors">
          Cancelar
        </button>
      </div>
    </form>
